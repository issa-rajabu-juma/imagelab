...
sp = preprocessor.SimplePreprocessor(227, 227)
pp = preprocessor.PatchPreprocessor(227, 227)
...
model.fit_generator(trainGen.generator(),
                    ...
                    validation_data=valGen.generator(),validation_steps=valGen.num_images //128,
                    epochs=75,
